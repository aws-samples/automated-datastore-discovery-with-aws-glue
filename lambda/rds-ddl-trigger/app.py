...
RDS_GLUE_QUEUE_URL_ENV_VAR = "RDS_GLUE_QUEUE_URL"
...
def lambda_handler(event, context):
    ...
    rds_glue_initial_queue_url = os.environ.get(RDS_GLUE_QUEUE_URL_ENV_VAR)
    if not rds_glue_initial_queue_url:
        raise MissingEnvironmentVariable(
            f"{RDS_GLUE_QUEUE_URL_ENV_VAR} environment variable is required")
    ...
    # send message to Glue Initial Fn Triggering Queue
    _send_message_to_sqs(
        sqs_client, 
        rds_glue_initial_queue_url, 
        valid_event)
