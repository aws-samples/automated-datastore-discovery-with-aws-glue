...
data_frame_inter = data_frame. \
                    ...
                    withColumn("data_source_type", lit("dynamodb")). \
                    withColumn("ddbTableID", lit(args["ddbTableID"])). \
                    withColumn("ddbTableARN", lit(args["ddbTableARN"])). \
                    withColumn("ddbTableName", lit(args["ddbTableName"])). \
